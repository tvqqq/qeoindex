...
export const ADMIN_JOB_CATALOG: AdminJobDefinition[] = [
  ...
  },
  {
    ...
    scheduleIct: "Mỗi 5p (09:00-14:55 T2-T6)",
  ...
  },
  {
    ...
    description: "Kiểm tra và cập nhật lịch sử TTAI lúc 01:00 ICT khi kỳ báo cáo tài chính thay đổi.",
    group: "provider",
    scheduleUtc: "0 18 * * *",
    scheduleIct: "01:00 hàng ngày",
    scheduleKind: "point",
    schedulerName: "kfsp-ttai-history-daily-1am-ict",
    scheduleDays: "daily",
