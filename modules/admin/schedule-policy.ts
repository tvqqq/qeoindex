...
export function schedulePolicyForJobKey(key: string): SchedulePolicy | null {
  if (key === "qeoindex.eod_pipeline") return { kind: "fixed_time", timezone: ICT_TIMEZONE, cadence: "weekdays", minuteOfDay: 901, completionDeadlineMinuteOfDay: 1435, graceMinutes: 30 }
  ...
  if (key === "qeoindex.chart_archive_catchup") return { kind: "fixed_time", timezone: ICT_TIMEZONE, cadence: "weekdays", minuteOfDay: 1005, graceMinutes: 30 }
