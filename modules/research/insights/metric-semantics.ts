...
export const INSIGHTS_METRIC_SEMANTICS: readonly InsightMetricSemantic[] = [
  ...
  },
  {
    ...
    provenanceNote: "Heuristic tính từ tỷ lệ mã giảm và biến động VNIndex tại modules/research/insights/data.ts.",
  },
  {
  ...
  },
  {
    ...
    provenanceNote: "Market feed quote tại modules/ai-council/market.ts.",
  },
  {
    key: "vnindex_sma20",
    label: "VNIndex SMA20",
    ...
    provenanceNote: "Market benchmark derivation tại modules/ai-council/market.ts.",
  },
  {
  ...
  },
  {
    ...
    provenanceNote: "Derived per modules/ai-council/market.ts.",
  },
  {
    key: "ma_breadth",
