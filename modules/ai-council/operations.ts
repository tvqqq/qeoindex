...
import { applyCouncilWeightProfile } from "@/modules/ai-council/calibration"
import { AiCouncilUpstreamStaleError, assertAiCouncilEodFreshness } from "@/modules/ai-council/freshness"
import {
  AI_COUNCIL_LLM_PROMPT_VERSION,
  runSelectedAiCouncilLlmDebates,
} from "@/modules/ai-council/llm"
import { loadCouncilWeightProfile, refreshAiCouncilLearningState } from "@/modules/ai-council/learning"
import { syncAiCouncilMarketBenchmark } from "@/modules/ai-council/market"
import { persistAiCouncilData } from "@/modules/ai-council/persistence"
import { enrichCouncilStocksForDebate } from "@/modules/ai-council/pre-market-evidence"
...
export async function runAiCouncilDebateOperation(
  ...
  return {
    ...
    tickerKnowledge: {
      contextVersion: evidenceFidelity.tickerKnowledgeContextVersion,
      enabled: evidenceFidelity.tickerKnowledgeEnabled,
      ready: evidenceFidelity.tickerKnowledgeReady,
      empty: evidenceFidelity.tickerKnowledgeEmpty,
      unavailable: evidenceFidelity.tickerKnowledgeUnavailable,
      reused: evidenceFidelity.tickerKnowledgeReused,
      persisted: evidenceFidelity.tickerKnowledgePersisted,
      missingRunIdentities: evidenceFidelity.tickerKnowledgeMissingRunIdentities,
    },
    validationBootstrap,
