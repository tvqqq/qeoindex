...
export const KFSP_FIELD_CATALOG: KfspFieldDefinition[] = [
  ...
  common("gia_co_phieu_hien_tai", "price", "Giá", "Giá cổ phiếu tại thời điểm snapshot, đơn vị nghìn đồng.", "price"),
  ...
  common("rsm", "rs_medium", "RSm", "Sức mạnh giá tương đối trung hạn."),
  common("rsl", "rs_long", "RSl", "Sức mạnh giá tương đối dài hạn."),
