...
test("Wyckoff watchlist is compact, sector-grouped, column-tinted and tooltip-free", () => {
  ...
  assert.match(infographic, /bank: Landmark/)
  assert.match(infographic, /securities: LineChart/)
  assert.match(infographic, /consumer: ShoppingBag/)
  assert.match(infographic, /"real-estate": Building2/)
  assert.match(infographic, /"industrial-tech": Layers3/)
  assert.match(infographic, /other: Compass/)
  assert.match(infographic, /xl:grid-cols-\[500px_minmax\(0,1fr\)\]/)
  assert.match(infographic, /2xl:grid-cols-\[520px_minmax\(0,1fr\)\]/)
  ...
  assert.match(infographic, /toggleVisibleGroups/)
  assert.match(infographic, /aria-expanded=\{!collapsed\}/)
  assert.match(infographic, /Mở tất cả/)
  assert.match(infographic, /Thu gọn/)
...
test("watchlist phase chips use compact labels, smaller phrase text and fixed alignment", () => {
  ...
  assert.match(infographic, /w-\[92px\]/)
  assert.match(infographic, /grid-cols-\[14px_minmax\(0,1fr\)\]/)
  assert.match(infographic, /text-\[10\.5px\]/)
  assert.match(infographic, /text-\[11\.5px\]/)
  assert.match(infographic, /min-h-\[56px\]/)
