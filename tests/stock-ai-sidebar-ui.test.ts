...
test("StockAiSidebar updates 5 pillars title and removes old score and spectrum track", () => {
  const code = source("components/stock-detail/stock-ai-sidebar.tsx")
  ...
  // Standalone confidence spectrum slider track is removed from sidebar
  assert.doesNotMatch(code, /Độ tin cậy \(Confidence\)/)
})
