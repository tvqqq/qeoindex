...
test("QEO-150 recovery is a machine-only canonical subset flow, not a bootstrap or SLA bypass", () => {
  ...
  assert.match(route, /mode === "chart-maintenance-recovery"/)
  ...
  // The normal scheduled workflow must keep its original SLA gates.
