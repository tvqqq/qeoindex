...
function PhaseNarrative({ study }: { study: WyckoffChartStudy }) {
  const items = [
    {
      label: "Hiện tại",
      value: study.phaseGuide.now,
      icon: <Radar className="size-4" />,
      accent: "cyan" as const,
    },
    {
      label: "Cần quan sát tiếp",
      value: study.phaseGuide.next,
      icon: <CheckCircle2 className="size-4" />,
      accent: "emerald" as const,
    },
    {
      label: "Rủi ro / phủ định",
      value: study.phaseGuide.risk,
    ...
    <div className="min-h-screen bg-[#05080d] font-ticker text-slate-100">
      ...
      <main className="mx-auto max-w-[2000px] px-3 py-4 sm:px-4 lg:px-5 xl:px-6">
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_390px] 2xl:grid-cols-[minmax(0,1fr)_420px]">
          ...
          <Card className="sticky top-3.5 hidden h-[calc(100vh-76px)] min-h-[660px] gap-0 overflow-hidden rounded-2xl border border-white/[0.09] bg-[#090e15] py-0 ring-0 xl:flex">
