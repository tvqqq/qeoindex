...
const RISK_PLAN_LABEL_VI: Record<string, string> = {
  ...
  "Stop-Out & Holiday Rules": "Quy tắc dừng lỗ & nghỉ giao dịch",
  "Consecutive Stop-Outs": "Số lần dừng lỗ liên tiếp",
  "Stop-Out Threshold": "Ngưỡng dừng lỗ liên tiếp",
  "Rolling Trade Loss Window": "Cửa sổ giao dịch thua lỗ",
  "Rolling Trade Count": "Số giao dịch trong cửa sổ",
  ...
  "Execution Rules": "Quy tắc thực thi",
  ...
  "Scaling": "Quy tắc gia tăng/giảm vị thế",
  ...
  "Diversification & Risk Capital": "Đa dạng hóa & vốn chịu rủi ro",
  "Diversification Limits": "Giới hạn đa dạng hóa",
  "Max Ticker Concentration": "Tập trung tối đa mỗi mã",
  "Max Sector Risk": "Rủi ro ngành tối đa",
  "Concentration Warning": "Cảnh báo tập trung",
  "Max Concurrent Open Positions": "Số vị thế mở đồng thời tối đa",
