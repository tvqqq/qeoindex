...
export function TacticalPositionCard({ position, onAddTransaction }: TacticalPositionCardProps) {
  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.045] via-[#0d1118] to-[#090c12] shadow-[0_18px_55px_rgba(0,0,0,0.18)]">
      ...
      <div className="space-y-4 p-5">
        ...
        <Button
          ...
          className="h-10 w-full rounded-xl border-violet-400/25 bg-violet-400/[0.08] text-sm font-bold text-violet-200 hover:bg-violet-400/[0.14] hover:text-violet-100"
        >
