...
export function LiveMarketBoard({ universe }: { universe: BoardUniverseStock[] }) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-background">
      ...
      <div className="flex items-center gap-4 border-b border-border px-4 py-2 text-[11px] text-muted-2">
        <span className="flex items-center gap-1.5"><Activity className="h-3.5 w-3.5" /> Top 50 HOSE từ Notion</span>
