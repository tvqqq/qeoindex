...
- The quote reconcile is session-guarded and preserves a newer realtime quote if one arrives while the request is in flight; its current-session reference may still update the baseline.
