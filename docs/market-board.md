...
- Notion's `Wyckoff Universe — Top 100 HOSE` database is the source of truth for membership, active status, rank, market capitalization, and sector. StockOS must not replace that membership with a hard-coded market list.
